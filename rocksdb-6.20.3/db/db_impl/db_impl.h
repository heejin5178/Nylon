...
class DBImpl : public DB {
 ...
 private:
  ...
  void MaybeScheduleFlushOrCompaction(int is_high = 0);
  ...
  // hj added
  static void BGWorkMidCompaction(void* arg);
  static void BGWorkFlush(void* arg);
  static void BGWorkPurge(void* arg);
  static void UnscheduleCompactionCallback(void* arg);
  static void UnscheduleFlushCallback(void* arg);
  void BackgroundCallCompaction(PrepickedCompaction* prepicked_compaction,
                                Env::Priority thread_pri, Status& s_, bool high_compaction = false);
  ...
  // hj added: count how many background compactions are running or have been scheduled in
  // the MID pool
  int bg_mid_compaction_scheduled_;
