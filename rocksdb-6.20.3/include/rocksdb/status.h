...
class Status {
 public:
  ...
  //hj added
  static Status HighCompaction(SubCode msg = kNone) { return Status(kHighCompaction, msg); }
  static Status HighCompaction(const Slice& msg, const Slice& msg2 = Slice()) {
    return Status(kHighCompaction, msg, msg2);
  }
  ...
  //hj added
  bool IsHighCompaction() const {
    MarkChecked();
    return code() == kHighCompaction;
  }
